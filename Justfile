# omux.xoxd.ai — SvelteKit static site task runner
# Prerequisites: just, direnv (loads Nix devShell), Nix with flakes
# Quick Start: direnv allow && just setup && just dev
#
# See AGENTS.md and docs/spec/omux-website-bootstrap-2026-04-29.md.
...
gh-repo:
    gh repo view tinyland-inc/omux.xoxd.ai --web
