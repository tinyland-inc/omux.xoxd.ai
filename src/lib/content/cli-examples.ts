...
export const INSTALL_CHANNELS: InstallChannelRow[] = [
	{
		channel: 'npm',
		status: 'live',
		statusLabel: 'live (v0.1.7)',
		description: 'Published from CI release tarballs; the private-source 0.1.7 publish used provenance disabled.',
	...
	},
	{
		...
		status: 'live',
		statusLabel: 'live (v0.1.7)',
		description: 'Public Jess-owned tap with strict local install QA and parsed stable-version proof.',
		citation: 'oauth-mux/docs/adoption.md:12-20 + docs/spec/homebrew-public-lane-decision-2026-05-01.md:119-123',
	},
	{
		channel: 'deb / rpm',
		status: 'live',
		statusLabel: 'live (v0.1.7 packages)',
